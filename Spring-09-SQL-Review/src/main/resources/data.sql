...
select *
from employees
where department not in ('Grocery', 'Decor', 'Sprts');
...
--return all employees work in Asia or Canada and make more than 130k
select *
from regions;
-- select * from employees where region_id in('4','5','6') and salary > 130000;
select *
from employees
...
--write a query that returns the names of those students that are taking the the courses Physics and US History
...
select first_name
     , salary
     , case
           when salary < 100000 then 'UDERPAID'
